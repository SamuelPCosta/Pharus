...
ENGINE = InnoDB;
ALTER TABLE pharus.dicas 
ADD CONSTRAINT `fk_dicas`
FOREIGN KEY (`admin`)
REFERENCES `pharus`.`admin` (`usuario`);

-- POVOAMENTO DE ADMIN
INSERT INTO pharus.admin (usuario, nome, email, senha, admin) 
VALUES ('Samuel', 'Samuel Soares Pereira Costa', 'ssoares981@gmail.com', '7cbdad5346d75ff3f24b91543f0913a8', '1');

-- POVOAMENTO DE DICAS
INSERT INTO pharus.dicas (dica_a, dica_b, dica_c, admin) 
...
INSERT INTO dicas (dica_a, dica_b, dica_c, admin) 
