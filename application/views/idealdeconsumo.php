		        ...
		        <div class="row align-items-center">
	     		...
	     		<div class="col-xl-6 col-md-12"><!--Div do questionário-->
	     			...
	     			<form method="post" action="#">
	     				<input type="radio" name="resposta" value="r1" id="r1"> 
					  	<label for="r1">
					  		<!--<button type="submit" class="btn">-->
					  		<div class="alternativas"><h4>Alternativa a</h4></div>
					  		<!--</button>-->
					  	</label>
					  	<input type="radio" name="resposta" value="r2" id="r2"> 
					  	<label for="r2"> 
					  		<div class="alternativas"><h4>Alternativa b</h4></div>
					  	</label>
					  	<input type="radio" name="resposta" value="r3" id="r3"> 
					  	<label for="r3">
					  		<div class="alternativas"><h4>Alternativa c</h4></div>
					  	</label>
