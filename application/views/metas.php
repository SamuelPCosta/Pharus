			...
			<div class="card py-5 px-5 my-4 shadow card-theme mt-5">
				<div class="row align-items-center">
					<div class="col-xl col-md-12 mx-auto px-0">
						...
						<button type="submit" class="btn theme mx-auto" style="width:100%; border: 4px solid #3b94af; cursor: unset;"><?php 
		        		$meta = $this->session->userdata('meta'); 
		     			if ($meta!=NULL) {
		     				echo $this->session->userdata('mensagem');
		     			}		
            ...
            <div class="container texto_metas px-4" style="transform: translateY(-50px);">
