			<div class="container my-5 containerinfo containerinfo1visaogeral" style="overflow: hidden;">	<!-- style="overflow-y: hidden" -->
		        ...
		        <div class="row px-3">
		        	<div col-xl-6 col-lg-12>
		        		<div class="d-block section" style="height: 100px" id="pontosvisaogeral">
			        		<div class="row pt-4 icones">
				        		<div class="col-xl-2 col-lg-4 col pt-3 theme">
				        			<a href="#" onclick="point('stop', 'point1', 'texto1')" title="Ícone de marcador de ponteiro semelhante a um velocimetro" class="point point1 imagematualdocirculo"><i class="fas fa-tachometer-alt align-middle d-table-cell" style="font-size: 3em"></i>
				        		...
				        		<div class="col-xl-2 col-lg-4 col pt-3 theme">
				        			<a href="#" onclick="point('primeirospassos', 'point2', 'texto2')" title="Ícone de pegadas" class="point point2" style="margin-left: -3px"><i class="fas fa-shoe-prints align-middle d-table-cell" style="font-size: 3em"></i>
				        		...
				        		<div class="col-xl-2 col-lg-4 col pt-3 theme">
				        			<a href="#" onclick="point('comvoce', 'point3', 'texto3')" title="Ícone de aperto de mãos" class="point point3"><i class="fas fa-handshake align-middle d-table-cell" style="font-size: 3em"></i>
				        			<br><br><br><i class="fas fa-circle align-middle d-table-cell pl-3 position-relative text-center" style="top: -28px; z-index: 1; width: 90px; padding-top: 0px!important;"></i></a>
				        		</div>
			        		</div>
		        		</div>
		        		...
		        		<div class="col-xl-12" id="giroimagens">
		        			<div class="float-right">
				        		<div class="rounded-circle float-right card card-theme shadow" id="circulofixo" style="height: 600px; width: 600px; display: flex; border: 2px solid; top:-250px; margin-right: 0px">
				        			<img src="<?= base_url()?>assets/img/stop.png" alt="Ilustração de mão fazendo sinal de pare. Ilustração de pegadas. Ilustração de um dedo apontando em sua direção." class="position-relative float-right" id="imagemdocirculo" style="z-index: 1; height: 100%; width: 100%; animation-timing-function: linear;">
				        			<img src="<?= base_url()?>assets/img/stop.png" alt="Ilustração de mão fazendo sinal de pare. Ilustração de pegadas. Ilustração de um dedo apontando em sua direção." class="position-absolute float-right" id="imagemdocirculo2" style="z-index: 1; height: 100%; width: 100%; animation-timing-function: linear;">
				        			<img src="<?= base_url()?>assets/img/circulomovimento.png" alt="" class="position-relative float-right cimg" id="circulomovimento" style="top: -596px; height: 100%; width: 100%">
				        		</div>
				        	</div>
			        	</div>
		        		<!-- //Esses dois circulos precisam se tornar responsivos -->
		        		...
		        		<br><br>
		        		<h2 class="theme mt-2 text-md-left text-center textogiro texto1 textodogirovisivel">Maneire seu consumo</h2>
		        		...
		        		<h2 class="theme mt-2 text-md-left text-center textogiro texto2">Dê o primeiro passo</h2>
		        		...
		        		<h2 class="theme mt-2 text-md-left text-center textogiro texto3">Agora é com você!</h2>
		...
		<div class="container containerinfo"  style=" object-fit: contain; transform: translateY(-200px);">
		    <div class="row mb-5">
		    	<div class="col-12">
		    		...
		    		<video width="100%" id="videoclip" autoplay muted preload loop controls><source id="mp4video" src="<?= base_url()?>assets/videos/video1.mp4" type=""></video>
		    	</div>	
		    </div>
		    <div class="row" id="opcoesdevideo">
		    	<div class="col text-center">
		    		<a href="#primeirospassos" onclick="video('video1', '1')">
						<img src="<?= base_url()?>assets/img/metas.png" class="rounded-circle" alt="Marcador de páginas" width=130>
		    	...
		    	<div class="col text-center">
		    		<a href="#primeirospassos" onclick="video('video2', '2')">
						<img src="<?= base_url()?>assets/img/simulador.png" class="rounded-circle" alt="Ícone de um notebook" width=130>
		    	...
		    	<div class="col text-center">
		    		<a href="#primeirospassos" onclick="video('video3', '3')">
						<img src="<?= base_url()?>assets/img/consumo.png" class="rounded-circle" alt="Ícone de moedas" width=130>
		    	...
		    	<div class="col text-center">
		    		<a href="#primeirospassos" onclick="video('video4', '4')">
						<img src="<?= base_url()?>assets/img/idealdeconsumo.png" class="rounded-circle" alt="Ícone de funil junto com uma moeda" width=130>
		    ...
		    <div class="row mb-5">
		    	...
		    	<h2 class="mt-4 mb-3 card text-lg-left text-center card-theme px-5 py-3 theme" id="primeirospassos" style="width: 100% !important;">Guia rápido</h2>
		    		...
		    		<div class="col-xl-4 col-md-12 px-3 mb-3" style="display: inline-block;">
					    <div class="card-theme card theme">
