				...
				<div class="d-flex justify-content-center form_container">
					<form method="post" action="login/autenticar"><!--Mandar para a página de checagem-->
						...
						<div class="input-group mb-3">
							...
							<input type="text" name="usuario" class="form-control input_user" value="" placeholder="Nome de usuário">
						</div>
					...
					<div class="d-flex justify-content-center mt-3 login_container">
						<button type="submit" name="button" class="btn login_btn btn-success">Entrar</button>
					</div>
				</form>
				<div class="mt-4">
