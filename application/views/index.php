		...
		<div id="page-content-wrapper">
			<div class="container first-container">
				<div class="row align-items-center">
					<div class="col-xl-6 col-lg-12">
						<div class="box">
							...
							if (isset($gasto)) {
								if ($gasto<=100) {
									?>
									<div class="chart anime" data-percent="<?php echo $gasto; ?>" data-scale-color="#ffb400"><span class="texto_grafico"><p><?php echo number_format($gasto, 1); ?>%</p><div id="tempo"><p>da meta em <br><span id="horas"><?php date_default_timezone_set('America/Sao_Paulo'); echo date('H'); ?></span> horas</p></span></div></div><!--Consumo do usuário, consumo do usuário também é passado como parâmetro para o % em data-percent (Acima)-->
									<?php
								} else {
									?>
					...
					<div class="col-xl-6 col-lg-12 text"><p class="mx-auto animeR">Aqui você pode visualizar rapidamente os dados gerais de seu consumo de energia de maneira mais ampla e dinâmica.</p></div>
				</div>
			</div>
			...
			<div class="container-fluid">
				...
				<div class="row align-items-center">
					...
					<div class="col-xl-6 col-lg-12 last-container py-5 text-center d-table">
						<i class="fas fa-lightbulb align-middle d-table-cell animeR"></i>
					</div>
				</div>
			</div>
		</div>
